...
def Graphic(a_min, a_max, bd_min, bd_max, b_min, b_max):
...
def main():
    ...
    while flag:
        ...
        a_max = float(input())
        print("Введите b дозревания минимальное:", end=" ")
        bd_min = float(input())
        print("Введите b дозревания максимальное:", end=" ")
        bd_max = float(input())
        print("Введите b минимальное:", end=" ")
        b_min = float(input())
        print("Введите b максимальное:", end=" ")
        b_max = float(input())

        # Вызов функций для построения графика и создания таблицы
        Graphic(a_min, a_max, bd_min, bd_max, b_min, b_max)
